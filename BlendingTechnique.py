...
test_upd = test[:, 1:739]
#----------------------------------------------------------------------------
# LOGISTIC REGRESSION NO SELECTED FEATURES NEW FEATURES
...
#----------------------------------------------------------------------------
# GBM NO SELECTED FEATURES NEW FEATURES TOP USERS
...
#----------------------------------------------------------------------------
# RANDOM FOREST NO SELECTED FEATURES NEW FEATURES TOP USERS
...
imp = improvement(group, accuracy)
print("Accuracy: ", round(accuracy, 2)) #67
print("Improvement: ", round(imp, 2)) #19
...
imp = improvement(group, accuracy)
print("Accuracy: ", round(accuracy, 2)) # 67
print("Improvement: ", round(imp, 2)) # 19.19
